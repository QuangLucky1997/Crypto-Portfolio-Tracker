...
object Constants {
    ...
    const val API_GEMINI = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"


    const val API_GEMINI_CHAT_BOT = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
    ...
    const val EXTRA_TIME_POST = "EXTRA_TIME_POST"
